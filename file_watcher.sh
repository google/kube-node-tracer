...
output_dir='./dump/'                            #Intermediary output path for pcap files which should be mounted to a GKE persistent storage volume as to not consume cluster resources
